...
public class SearchTree implements NodeList {
    ...
    private void performRemoval(MyList item, MyList parent) {
        ...
        if (item.next() == null) {
            ...
            MyList current = item.next();
            MyList leftmostParent = item;
    ...
    @Override
    public void traverse(MyList root) {
        // recursive method
        if (root != null) {
