...
//                }
//            } catch (SQLException e){
//                System.out.println("Error closing ResulySet : " + e.getMessage());
//            }
//            try {
//                if (statement != null){
//                    statement.close();
...
//            sb.append(" COLLATE NOCASE ");
    ...
    public List<SongArtist> queryArtistForSong(String songName, int sortOrder) {
        ...
        System.out.println(sb.toString());
        try (Statement stamenent = conn.createStatement();
             ResultSet results = stamenent.executeQuery(sb.toString())) {
...
//            int numRows = results.getInt("count");
...
//      using prepared statement
 ...
 //           ResultSet results = querySong.executeQuery();
   //         if (results.next()) {
     //           System.out.println("There is already song we cannot add");
     //       } else {
